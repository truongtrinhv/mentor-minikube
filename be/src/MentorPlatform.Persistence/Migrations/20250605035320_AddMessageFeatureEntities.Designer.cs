...
namespace MentorPlatform.Persistence.Migrations
{
    ...
    [Migration("20250605035320_AddMessageFeatureEntities")]
    partial class AddMessageFeatureEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MentorPlatform.Domain.Entities.Attachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MentorPlatform.Domain.Entities.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MentorPlatform.Domain.Entities.MentoringSession", b =>
                {
                    ...
                    b.HasIndex("ScheduleId")
                        .IsUnique()
                        .HasFilter("[RequestStatus] = 0");

                    b.ToTable("MentoringSessions");
                });

            modelBuilder.Entity("MentorPlatform.Domain.Entities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MentorPlatform.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MentorPlatform.Domain.Entities.Participant", b =>
                {
            ...
            modelBuilder.Entity("MentorPlatform.Domain.Entities.Attachment", b =>
                {
                    b.HasOne("MentorPlatform.Domain.Entities.Message", "Message")
            ...
            modelBuilder.Entity("MentorPlatform.Domain.Entities.MentoringSession", b =>
                {
                    ...
                    b.HasOne("MentorPlatform.Domain.Entities.Schedule", "OldSchedule")
                        .WithMany("OldMentoringSessions")
            ...
            modelBuilder.Entity("MentorPlatform.Domain.Entities.Message", b =>
                {
                    b.HasOne("MentorPlatform.Domain.Entities.Conversation", "Conversation")
                        .WithMany()
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MentorPlatform.Domain.Entities.User", "Sender")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("MentorPlatform.Domain.Entities.Notification", b =>
                {
                    b.HasOne("MentorPlatform.Domain.Entities.User", "Owner")
            ...
            modelBuilder.Entity("MentorPlatform.Domain.Entities.Schedule", b =>
                {
                    ...
                    b.Navigation("OldMentoringSessions");
                });
